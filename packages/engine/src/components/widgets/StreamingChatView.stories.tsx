...
export const Idle: Story = {
  render: () => <StaticStory messages={[
    { id: '1', role: 'system', text: 'Welcome! How can I help?', status: 'complete' },
  ]} />,
};

export const Thinking: Story = {
  render: () => <StaticStory isStreaming messages={[
...
export const MidStream: Story = {
  render: () => <StaticStory isStreaming messages={[
    ...
    { id: '2', role: 'ai', text: 'Here are the items currently at or below your low-stock threshold:\n\n• Widget A — 2 remaining\n• Gadget B — 1 remaining', status: 'streaming' },
  ]} />,
};
...
export const Complete: Story = {
  render: () => <StaticStory messages={[
    ...
    { id: '2', role: 'ai', text: 'Here\'s your dashboard summary:\n\n• 5 open deals worth $380,000\n• 3 new leads this week\n• Pipeline weighted value: $198,000', status: 'complete', actions: [
...
export const LongConversation: Story = {
  render: () => <StaticStory messages={[
    ...
    { id: '3', role: 'ai', text: 'You have 7 contacts across 5 companies. 2 are customers, 2 are prospects, 2 are leads, and 1 has churned.', status: 'complete' },
    { id: '4', role: 'user', text: 'Which ones are VIPs?', status: 'complete' },
    { id: '5', role: 'ai', text: 'Two contacts are tagged as VIP:\n\n• **Alice Johnson** (Acme Corp) — Active customer\n• **Eve Martinez** (Umbrella Ltd) — Active customer\n\nBoth have active deals in the pipeline.', status: 'complete', actions: [
      { label: '👤 Alice', action: 'c1' },
      { label: '👤 Eve', action: 'c5' },
    ] },
    { id: '6', role: 'user', text: 'What deals does Alice have?', status: 'complete' },
    { id: '7', role: 'ai', text: 'Alice Johnson has 2 deals:\n\n1. **Acme Enterprise License** — $120,000, Negotiation stage (75% probability)\n2. **Acme Support Renewal** — $30,000, Closed Won\n\nTotal pipeline value: $150,000', status: 'complete' },
  ]} />,
};
